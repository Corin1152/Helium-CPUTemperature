    ...
    var body: some View {
        NavigationView {
            List {
                ...
                Section {
                    Button(action: {
                        let report = HeliumTemperatureDiagnosticsBridger() ?? NSLocalizedString("(no diagnostics)", comment: "")
                        UIApplication.shared.alert(title: NSLocalizedString("Temperature Diagnostics", comment: ""), body: report)
                    }) {
                        HStack {
                            Label(NSLocalizedString("Temperature Diagnostics", comment: ""), systemImage: "thermometer")
                            Spacer()
                    ...
                    Label(NSLocalizedString("Diagnostics", comment: ""), systemImage: "stethoscope")
                } footer: {
                    Text(NSLocalizedString("Shows which temperature sources this device actually exposes. The same report is written to /var/mobile/Documents/HeliumTempDiag.txt", comment: ""))
                }
